...
using Survey.Mobile.Components.Pages.Dialog;
using System;
using System.Threading.Tasks;

namespace Survey.Mobile.Components.Pages.Levantamentos
{
    public partial class UpdateLevantamentoPage : ComponentBase
    {
        ...
        public async Task AddBloco()
        {
            ...
            if (!string.IsNullOrWhiteSpace(currentNome) && !string.IsNullOrWhiteSpace(currentDescricao))
            {
                ...
                {
                    var parameters = new DialogParameters<DialogCreatePavimento> { { x => x.Bloco, bloco }, { x => x.Color, MudBlazor.Color.Success } };
        ...
        {
            var parameters = new DialogParameters<DialogUpdateLuminaria> { { x => x.Pavimento, pavimento }, { x => x.FuncionarioId, Levantamento.FuncionarioId }, { x => x.Color, MudBlazor.Color.Success } };
